...
@auth
    <form method="post" action="{{ route('application._add') }}" enctype="multipart/form-data">
        ...
        <div class="form-group form-floating mb-3">
            <input type="text" class="form-control" name="profile_url" placeholder="e.g. LinkedIn" required="required" autofocus>
        ...
        <div class="form-group form-floating mb-3">
            <textarea class="form-control" name="cover_letter" placeholder="Cover Letter" required="required" autofocus></textarea>
